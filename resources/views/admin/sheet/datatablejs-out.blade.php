        ...
        $('#spreadsheet-table-out thead tr').clone(true).appendTo( '#spreadsheet-table-out thead' );
        $('#spreadsheet-table-out thead tr:eq(1) th').each( function (i) {
            var title = $(this).text();
        ...
        $("#spreadsheet-table-out").on('click', "span.change-request-status", function(){
            console.log($(this))
            let ele = $(this);
            $.ajax({
